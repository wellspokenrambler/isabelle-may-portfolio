<template>
  <header class="z-40 fixed shadow bg-purple w-screen flex flex-col md:flex-row justify-between items-center px-10 py-8">
    <div class="flex flex-row justify-between w-full items-end">
      <a href="/" class="transition duration-100 flex items-end text-white hover:text-blue active:text-blue-dark-20 md:-mb-2 border-b-2 border-transparent hover:border-blue active:border-blue-dark-20 leading-none" @mouseover="setHoverColor" @mouseleave="setDefaultColor" @mousedown="setActiveColor"
